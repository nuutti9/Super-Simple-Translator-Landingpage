...
const translations = {
  ...
  privacy: {
    en: {
      ...
      "meta.description": "Privacy Policy placeholder page for Super Simple Translator.",
      "brand.full": "Super Simple Translator",
      "nav.features": "Features",
      "nav.faq": "FAQ",
      "nav.privacy": "Privacy",
      ...
      "meta.description": "Super Simple Translatorin tietosuojakäytännön paikkasivu.",
      "brand.full": "Super Simple Translator",
      "nav.features": "Ominaisuudet",
      "nav.faq": "UKK",
      "nav.privacy": "Tietosuoja",
  ...
  terms: {
    en: {
      ...
      "meta.description": "Terms of Service placeholder page for Super Simple Translator.",
      "brand.full": "Super Simple Translator",
      "nav.faq": "FAQ",
      "nav.privacy": "Privacy",
      "nav.terms": "Terms",
      ...
      "meta.description": "Super Simple Translatorin käyttöehtojen paikkasivu.",
      "brand.full": "Super Simple Translator",
      "nav.faq": "UKK",
      "nav.privacy": "Tietosuoja",
      "nav.terms": "Ehdot",
